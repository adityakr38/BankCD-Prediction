...
def index():
    if request.method == 'POST':
        try:
            ...
            generation = str(request.form['generation'])
       
         
            data = [age, job, marital, education, default, balance, housing, loan, contact,
                        day, month, duration, campaign, pdays, previous, poutcome, generation]
